...
STOCKPAGEURL = []
#宏变量存储日期列表，事先爬取
##dateList = ['1998-02-20', '1998-02-20']
dateList=['2019-09-%d'% x for x in range(10,31)]
##生成链接列表的函数。
def Get_Url(num):
...
##        STOCKPAGEURL.append(urlFront+str(01810+i)+urlRear)
...
def CsvDownload(stockInfo):
    print(stockInfo[1])
    out = open('dataset3.csv','a', newline='')
